...
function table.assign(a,b,c)setfenv(b,setmetatable(c or{this=a},{__index=_G,__newindex=a}))()return a end
...
object=table.assign({},function()
	...
	function prototype(a,b)local c,d=b and a,a and b or a;local prototype=setmetatable({super=c,get=get,set=set,hash=hash},{__index=c,__call=this.create})return table.assign(prototype,d,{this=prototype,super=c})end
end);

-- Core Utilities Kit

coreKit=table.assign({},function()
	function time(a)if a then return time()<a*1000 end;return time()end
	font=table.assign({},function()
		HEIGHT,REGULAR,BOLD=6,{address=0,adjust={[2]="&",[1]="#$*?@%^%dmw",[-1]="\"%%+/<>\\{}",[-2]="()1,;%[%]`jl",[-3]="!'%.:|i"},width=5},{address=112,adjust={[3]="mw",[2]="#&",[1]="$*?@^%dMW~",[-1]="%%+/<>\\{}",[-2]="()1,;%[%]`jl",[-3]="!'%.:|i"},width=6}
	...
	graphics=table.assign({},function()
...
UIKit.Panel=object.prototype(function()
	...
	function constructor(self,a,b,c)self.elements,self.width,self.height={},a or self.width,b or self.height;if c then self:set(c)end end
