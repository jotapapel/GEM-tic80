...
UIKit.Icon = object.prototype(UIKit.Object, function()
	...
	function constructor(self,a,b,c)self.icon,self.label,self.drive=a,UIKit.Text(b,coreKit.font.REGULAR),c or 0;self.width,self.height=40,self.label.height+16 end
...
-- Desktop Program
_PROGRAM = object.struct(function()
